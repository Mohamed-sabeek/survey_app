      ...
      <nav className="bg-white/80 backdrop-blur-xl border-b border-slate-200 sticky top-0 z-50 px-4 lg:px-6 shadow-sm">
        <div className="max-w-6xl mx-auto flex justify-between h-16 items-center py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-black tracking-tight text-slate-900 uppercase leading-none">Intelligence Dashboard</h1>
              <p className="text-[9px] font-bold text-indigo-500 uppercase tracking-[0.2em] mt-1">Survey Control Center</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
             ...
             <button
               ...
               className="flex items-center px-5 py-2.5 text-xs font-black uppercase tracking-widest rounded-xl text-white bg-slate-900 hover:bg-rose-600 transition-all shadow-xl active:scale-95"
             >
          ...
          <div className="animate-fadeIn space-y-10">
            ...
            <section className="space-y-4">
               <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-lg font-black text-slate-800 uppercase tracking-tighter">Performance Summary</h2>
               </div>
               <StatsCards data={data} />
            </section>

            {/* 2. Deep Intelligence Section (Filter Driven) */}
            <section className="space-y-6 bg-white border border-slate-200 rounded-[2.5rem] p-4 lg:p-8 shadow-xl shadow-slate-200/50">
               {/* Advanced Filter Tabs */}
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-8">
                  <div>
                    <h3 className="text-xl font-black text-slate-900 tracking-tighter uppercase leading-none">Deep Analytics</h3>
                    <p className="text-[10px] font-bold text-slate-400 mt-1.5 uppercase tracking-widest">Filter by category</p>
                  </div>
                  <div className="flex flex-wrap gap-2.5 bg-slate-100 p-2 rounded-2xl">
                    <button
                    ...
                    {occupations.map(occ => (
                      <button
                        ...
                        className={`px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.1em] transition-all capitalize
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  ...
                  <InsightsSection data={filteredData} selectedOccupation={selectedOccupation} />
               </div>
            </section>
            ...
            <section className="space-y-4">
               <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-lg font-black text-slate-800 uppercase tracking-tighter">Submission Stream</h2>
               </div>
